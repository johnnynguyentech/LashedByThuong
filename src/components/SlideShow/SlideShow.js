        ...
        return (
            <Aux>
                <div className="SlideShow"> 
                    ...
                    <div className="modal fade" id="exampleModal17" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                <div className="modal-body">
                                    <img src={portfolio7} alt="..." id="modalPic"></img>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="modal fade" id="exampleModal18" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                <div className="modal-body">
                                    <img src={portfolio8} alt="..." id="modalPic"></img>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="modal fade" id="exampleModal19" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                <div className="modal-body">
                                    <img src={portfolio9} alt="..." id="modalPic"></img>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="column">
                            <img src={portfolio7} alt="..." data-toggle="modal" data-target="#exampleModal17"></img>
                            <img src={portfolio8} alt="..." data-toggle="modal" data-target="#exampleModal18"></img>
                            <img src={portfolio9} alt="..." data-toggle="modal" data-target="#exampleModal19"></img>
                        </div>
                    </div>
